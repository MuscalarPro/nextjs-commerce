...
export default function InformedMedicalConsentPage() {
  const content = `
    ...
    <ul>
      ...
      <li>You understand that all information submitted to MUSCALAR PRO will be part of your medical record, and you have the right to review and receive copies of your records in accordance with applicable law. For more information on how to access your records, please contact <a href="mailto:support@muscalarpro.com">support@muscalarpro.com</a>.</li>
