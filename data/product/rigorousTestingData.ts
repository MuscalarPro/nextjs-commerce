...
export const rigorousTestingData: TestingCard[] = [
  {
    ...
    detailSubtitle: 'The regulatory baseline for safety — but for us, only the starting point.',
    sections: [
      {
      ...
      },
      {
        ...
        content: 'Most supplements operate under basic "Registration." MuscalarPro maintains a "Central License" (#10023064000123), which requires the highest tier of recurring audits and infrastructure standards in India.'
      }
    ],
    facilityInfo: {
    ...
    footerQuote: '“Regulatory compliance is not the goal; it is the absolute minimum requirement before we begin our own internal validation.”',
    actionButton: {
  ...
  },
  {
    ...
    detailSubtitle: 'Good Manufacturing Practices — ensuring consistent quality where it matters most.',
    sections: [
      {
        title: 'WHAT GMP IS',
        content: 'GMP (Good Manufacturing Practice) is a system for ensuring that products are consistently produced and controlled according to quality standards. It is designed to minimize the risks involved in any pharmaceutical or supplement production that cannot be eliminated through testing the final product.'
      },
      {
    ...
    footerQuote: '“Quality is never an accident; it is always the result of high intention, sincere effort, intelligent direction, and skillful execution.”',
    actionButton: {
  ...
  },
  {
    ...
    detailSubtitle: 'Generally Recognized As Safe — the gold standard for ingredient toxicology.',
    sections: [
      {
        title: 'THE GRAS STANDARD',
        content: 'An ingredient is "GRAS" only when an independent panel of qualified experts (toxicologists, pharmacologists) reviews all scientific evidence and concludes the substance is safe under the conditions of its intended use.'
      },
      {
    ...
    footerQuote: '“Safety is the first pillar of longevity. We do not use molecules that are merely "legal"; we use those that are proven safe through rigorous toxicology.”',
    actionButton: {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: 'Most supplement certifications test once — usually at the point of initial approval — and never retest subsequent batches. NSF Certified for Sport tests every batch before it ships. If you aren’t a competitive athlete, you still benefit from the strictest per-batch screening standard available to any dietary supplement sold anywhere in the world.'
      }
    ],
    actionButton: {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: 'Most supplements rely on mechanism claims — ‘this molecule does X in a petri dish, so it should do Y in your body.’ Placebo-controlled human evidence is the only way to verify that mechanism actually translates to measurable outcomes in people. Urolithin A is one of a small handful of longevity molecules with human evidence at this level of rigour.',
        quote: 'Approximately 15–20% of participants in Urolithin A trials do not show measurable response — partly because roughly 40% of adults already produce Urolithin A endogenously from dietary ellagitannins in foods like pomegranate, walnuts, and berries. For this subgroup, the incremental benefit of supplementation is smaller.'
      }
    ],
    trialSummary: {
      length: '16 weeks',
  ...
  },
  {
    ...
    detailSubtitle: 'Every batch, tested by labs we don’t own — and can’t influence.',
    sections: [
      {
      ...
      },
      {
        ...
        content: 'Independent laboratories accredited by NABL (India) and ISO/IEC 17025 (international). We rotate between multiple labs across batches to prevent any single lab relationship from biasing results.',
        quote: 'We don’t disclose which labs tested which batch in advance. This prevents gaming. You see the results after they’re in.'
      },
      {
        title: 'VERIFY YOUR SPECIFIC BATCH',
        content: 'Every M3 bottle carries a unique batch number printed near the expiry date. Email us that batch number and we’ll send back the full Certificate of Analysis — the actual raw results for your specific bottle, not a generic marketing PDF.',
        actionButton: {
      ...
      },
      {
        ...
        content: 'Most supplement brands test their product once — usually to secure a certification mark — then skip re-testing subsequent production. Per-batch testing means every bottle you receive has its own verifiable chain of evidence. If a batch fails any threshold, that batch doesn’t ship. Full stop.'
      }
    ]
  }
];
