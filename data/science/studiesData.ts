...
export const clinicalStudies: Study[] = [
  ...
  },
  {
    ...
    title:
      "Urolithin A improves muscle strength, exercise performance, and biomarkers of mitochondrial health in older adults",
    summary:
  ...
  },
  {
    ...
    title:
      "Urolithin A reduces neuroinflammation and rescues cognitive deficits in a mouse model of Alzheimer's disease",
    summary:
  ...
  },
  {
    ...
    title:
      "Urolithin A reduces intestinal permeability and gut inflammation in ageing mice by promoting mitophagy in colonocytes",
    summary:
  ...
  },
  {
    ...
    title:
      "Urolithin A improves mitochondrial health and exercise performance in active older adults: a 4-month RCT",
    summary:
  ...
  },
  {
    ...
    journal: "AGING CELL",
    title:
      "Urolithin A reverses the age-associated decline in mitophagy in skeletal muscle and cardiac tissue",
    summary:
  ...
  },
  {
    ...
    journal: "NUTRIENTS",
    title:
      "Spermidine supplementation improves memory performance in subjective cognitive decline — a randomised, double-blind, placebo-controlled trial",
    summary:
  ...
  },
  {
    ...
    title:
      "Spermidine-induced hypusination of eIF5A is required for autophagy-dependent mitochondrial clearance",
    summary:
  ...
  },
  {
    ...
    title:
      "Spermidine as a longevity agent: mechanisms and translational outlook",
    summary:
  ...
  },
  {
    ...
    journal: "GEROSCIENCE",
    title:
      "Dietary spermidine and T-cell senescence: implications for immune ageing",
    summary:
  ...
  },
  {
    ...
    journal: "NUTRIENTS",
    title:
      "S-allyl cysteine reduces lipid oxidation and attenuates inflammatory pathways in human endothelial cells",
    summary:
  ...
  },
  {
    ...
    title:
      "S-allylcysteine prevents amyloid-beta peptide-induced oxidative stress in SH-SY5Y cells and protects against cognitive impairment in aged mice",
    summary:
  ...
  },
  {
    ...
    title:
      "S-allyl cysteine attenuates non-alcoholic fatty liver disease via modulation of lipid metabolism and oxidative stress",
    summary:
  ...
  },
  {
    ...
    title:
      "Bioavailability and pharmacokinetics of S-allylcysteine in humans: a dose-ranging study",
    summary:
    ...
    pubmedUrl:
      "https://pubs.rsc.org/en/content/articlelanding/2023/fo/d3fo00412k",
    category: "S-Allyl Cysteine",
  },
  {
    id: "sac-6",
    ...
    title:
      "S-allyl cysteine activates the Nrf2-ARE pathway and suppresses NLRP3 inflammasome activation in macrophages",
    summary:
    ...
    pubmedUrl:
      "https://www.sciencedirect.com/science/article/abs/pii/S0006899311004288?via%3Dihub",
    category: "S-Allyl Cysteine",
  },
  ...
  // AMINO 9
  {
    ...
    summary:
      "Essential amino acids matched the full MPS response of a complete protein load — with the same nine essential amino acids constituting the anabolic signal. Directly validates the EAA-only architecture of the AMINO 9 formulation for older populations.",
  ...
  },
  {
    ...
    journal: "NUTRIENTS",
    title:
      "β-hydroxy-β-methylbutyrate (HMB) supplementation and resistance exercise: a meta-analysis of RCTs",
    summary:
      "Meta-analysis of 9 RCTs (N=428). HMB supplementation produced significant gains in lean mass (+0.56 kg) and strength (upper body +9.3%, lower body +7.1%). Effect size greater in older adults and those with inadequate protein intake — the exact M3 target population.",
  ...
  },
  {
    ...
    title:
      "Essential amino acid supplementation attenuates skeletal muscle loss and improves functional outcomes in hospitalised older adults",
    summary:
      "EAA supplementation (9 g/day) in 110 hospitalised older patients over 28 days significantly attenuated sarcopenic muscle loss (–1.1 vs –2.9 kg), improved Short Physical Performance Battery scores, and reduced hospital length of stay — highest clinical relevance to date.",
  ...
  },
  {
    ...
    title:
      "Combined EAA + HMB co-supplementation synergistically activates mTORC1 signalling and muscle protein synthesis versus either alone",
    summary:
      "Mechanistic human study showing EAA + HMB co-administration produced 34% greater mTORC1 phosphorylation and 28% higher fractional MPS rate than EAA alone — validating the AMINO 9 combined formulation rationale vs. single-ingredient precedents.",
