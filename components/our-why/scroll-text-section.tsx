    ...
    <>
      <section className="relative w-full bg-white">
        <div className="mx-auto max-w-3xl px-4 pt-12 md:pt-0">
          <h2 className="mb-6 font-inter text-left text-[2rem] md:text-[3.5rem] font-normal text-black opacity-100 md:opacity-10">
          ...
          {scrollTextContent.paragraphs.map((para, i) => (
            <p
              key={i}
              className="mb-4 font-inter text-left text-[1.75rem] font-normal text-[#71717a]"
            >
              {para}
            </p>
          ))}
