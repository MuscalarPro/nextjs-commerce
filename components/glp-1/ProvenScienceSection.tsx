    ...
    <section className="bg-[#1a2d2f] py-24 text-white">
      <div className="mx-auto max-w-6xl px-4 text-center">
        <h2 className="mb-6 text-[42px] font-normal leading-[1.1] md:text-[64px] tracking-tight">
          Clinically proven at <br /> the{" "}
          <span className="text-[#d2f392]">cellular level</span>
        </h2>
        <p className="mx-auto mb-16 max-w-2xl text-[16px] text-white/60 md:text-[18px] leading-relaxed">
          Every molecule in M3 has passed rigorous human trials. This isn&apos;t
          wellness marketing — it&apos;s precision biology backed by a decade of
          research.
        </p>
        ...
        <div className="mb-8 grid grid-cols-2 gap-4 md:grid-cols-4">
          {stats.map((stat, idx) => (
            ...
            >
              <span className="mb-2 text-[42px] font-normal text-[#d2f392] tracking-tighter">
                {stat.value}
              </span>
              <span className="text-[11px] uppercase tracking-widest text-white/50 leading-relaxed max-w-[140px]">
                {stat.label}
              </span>
            </motion.div>
          ))}
        ...
        <p className="mb-12 text-[10px] text-white/30 uppercase tracking-widest">
          *Based on Urolithin A clinical trial data. Results may vary. Not
          evaluated by the FDA or FSSAI.
        </p>
