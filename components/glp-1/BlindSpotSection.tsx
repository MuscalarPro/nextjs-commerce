    ...
    <section className="relative overflow-hidden py-24 text-white">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 text-center">
        ...
        <h2 className="mb-12 text-[42px] font-normal leading-[1.1] md:text-[64px] tracking-tight">
          Your GLP-1 <br/> breakthrough has a <span className="text-[#d2f392]">blind spot</span>
        </h2>
        ...
        <div className="mx-auto mb-12 max-w-[27rem] text-[18px] md:text-[22px] leading-[1.1]">
          <p>
            <span className="text-[#d2f392] font-medium">You're losing weight</span>, but 25% is muscle. <br/>
        ...
        <div className="mb-24 flex w-full gap-4 overflow-x-auto pb-6 snap-x snap-mandatory [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
          ...
          <div className="flex w-[85vw] md:w-[320px] lg:w-[340px] shrink-0 snap-start flex-col rounded-[24px] bg-white/5 p-6 text-left backdrop-blur-md border border-white/10">
            <div className="mb-6">
              <span className="rounded-full bg-white/10 px-3 py-1 text-[10px] font-bold text-white/80 uppercase">ADD-ON</span>
            </div>
            <h4 className="mb-1 text-[20px] font-medium">Longevity Labs Test</h4>
            <p className="mb-8 text-[12px] text-white/50">130+ Biomarkers · Blood Panel</p>
            <div className="mt-auto flex items-center justify-between">
              <div className="flex flex-col">
                <span className="text-[12px] text-white/50 line-through mb-1">₹11,249</span>
                <span className="text-[20px] font-bold">₹8,999 <span className="text-[12px] font-normal text-white/50">one-time</span></span>
              </div>
              <span className="flex h-8 w-8 items-center justify-center rounded-full border border-white/20 text-[14px]">→</span>
            </div>
          </div>
          ...
          <div className="flex w-[85vw] md:w-[320px] lg:w-[340px] shrink-0 snap-start flex-col rounded-[24px] bg-white/5 p-6 text-left backdrop-blur-md border border-white/10">
            <div className="mb-6">
              <span className="rounded-full bg-white/10 px-3 py-1 text-[10px] font-bold text-white/80 uppercase">NEW</span>
            </div>
            <h4 className="mb-1 text-[20px] font-medium">Biological Age Report</h4>
            <p className="mb-8 text-[12px] text-white/50">Muscular · Metabolic · Hormonal</p>
            <div className="mt-auto flex items-center justify-between">
              <div className="flex flex-col">
                <span className="text-[20px] font-bold">₹3,499 <span className="text-[12px] font-normal text-white/50">one-time</span></span>
              </div>
              <span className="flex h-8 w-8 items-center justify-center rounded-full border border-white/20 text-[14px]">→</span>
            </div>
          </div>
        ...
        <div className="mx-auto mt-16 flex max-w-4xl flex-col items-center justify-between gap-6 border-t border-white/10 pt-8 text-[12px] font-normal text-white/50 md:flex-row">
           <span className="flex-1 text-left">~25% lose strength on GLP-1 within 6 months</span>
           <span className="flex-1 text-center">~17% elevated sarcopenia risk post-GLP-1</span>
           <span className="flex-1 text-right">Up to 40% of weight loss may be lean mass</span>
        </div>
      </div>
    </section>
  );
