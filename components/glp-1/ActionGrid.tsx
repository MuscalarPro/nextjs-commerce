...
const cards = [
  {
    ...
    image:
      "https://cdn.shopify.com/s/files/1/0732/2556/8425/files/1_cb42bb6f-f083-4a1b-987f-827c9a4d4aa4.png?v=1777629248",
    href: "/product/decode-peak-performance-m3",
  },
  {
    title: "Track your biomarkers",
    image:
      "https://cdn.shopify.com/s/files/1/0732/2556/8425/files/2_832ff981-ef6b-423a-a1b8-b7beb1aba54d.png?v=1777629249",
    href: "/science",
  },
  {
    title: "Decode your musclespan",
    image:
      "https://cdn.shopify.com/s/files/1/0732/2556/8425/files/9a5298152c49f33cc0dc733e1d938c6ed24e1357.png?v=1777280797",
    href: "/quiz",
  },
  {
    title: "Unsure where to begin? Start here",
    image:
      "https://cdn.shopify.com/s/files/1/0732/2556/8425/files/d5d9890b27365cef7dd9a57e12e345c6698d963b.png?v=1777280804",
    href: "/consultation",
    isLargeText: true,
  },
];
          ...
          <div className="relative z-10 flex h-full flex-col justify-between">
            <div className="max-w-[240px]">
              <div className="mb-2 inline-flex items-center gap-1.5 rounded-full bg-[#d4f268] py-[3px] pl-3 pr-[3px]">
                ...
                <span className="rounded-full bg-[#ff4040] px-2 py-[2px] text-[10px] font-bold text-white">
                  20% OFF
                </span>
              </div>
              <h3 className="heading-h3 font-light text-white leading-[25px]">
            ...
            <div className="flex w-full items-end justify-between">
              <Link
                href="/product/decode-peak-performance-m3"
                className="body-text-sm font-medium text-white/70 transition-colors hover:text-white"
              >
        ...
        <div className="relative h-[280px] overflow-hidden rounded-[22px] bg-[#939ca0] p-10 transition-all hover:brightness-105 md:h-[209px]">
          ...
          <div className="relative z-10 flex h-full flex-col justify-between">
            ...
            <div className="flex w-full items-end justify-between">
              <Link
                href="/quiz"
                className="body-text-sm font-medium text-white transition-colors hover:text-[#1a3b1a]"
              >
        ...
        {cards.map((card, idx) => (
          ...
          >
            ...
            <div className="relative z-10 flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-[#1a3b1a]/10 bg-white/50 backdrop-blur-sm transition-all group-hover:bg-[#1a3b1a] group-hover:border-[#1a3b1a]">
              <span className="text-xs text-[#1a3b1a] transition-colors group-hover:text-white">
                →
              </span>
            </div>
          </Link>
