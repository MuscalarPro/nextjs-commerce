  ...
  return (
    <section className="w-full h-screen min-h-[700px] flex items-center justify-center bg-white overflow-hidden">
      <div className="mx-auto max-w-[1440px] px-4 md:px-8 flex flex-col items-center text-center">
        {/* Main Heading Text */}
        <h1 className="relative z-10 flex flex-col items-center font-medium text-black">
          <motion.span
          ...
          <motion.span
            ...
            className="flex flex-wrap md:flex-nowrap items-center justify-center gap-x-2 md:gap-x-2 text-[30px] sm:text-[34px] md:text-[48px] md:mb-0 md:leading-none"
          >
            <span className="inline-block">[M3]</span>
            ...
            <span className="whitespace-nowrap md:leading-[1.2]">
              the formula
            </span>
          </motion.span>
          ...
          <motion.span
            ...
            className="text-[30px] sm:text-[34px] md:text-[48px] md:max-w-7xl mx-auto leading-none"
          >
            <span className="md:whitespace-nowrap leading-[1.2]">
              engineered to decode peak performance
            </span>
          </motion.span>
        </h1>
