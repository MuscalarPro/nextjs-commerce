...
const advisors: Advisor[] = [
  ...
  },
  {
    ...
    imageSrc: "/images/science/advisor-2.jpg", // Placeholder
  },
  {
    ...
    imageSrc: "/images/science/advisor-3.jpg", // Placeholder
  },
  {
    name: "Eric Verdin, MD",
    title: "CEO Buck Institute for Research on Aging, Scientific Advisor",
    ...
    imageSrc: "/images/science/advisor-4.jpg", // Placeholder
  },
];
  ...
  return (
    <section className="w-full bg-white py-10 md:py-20 border-t border-neutral-200">
      <div className="mx-auto max-w-[1440px] px-4 md:px-6">
        ...
        {/* Grid */}
        <div className="grid grid-cols-2 md:grid-cols-5 lg:grid-cols-8 gap-x-4 gap-y-12">
          {advisors.map((advisor, index) => (
            <div key={index} className="flex flex-col group cursor-pointer">
              {/* Image Container */}
              <div className="relative w-full aspect-[3/4] mb-6 bg-neutral-100 overflow-hidden">
                {/* 
                  Since we don't have real images yet, we render a placeholder. 
                  In a real app, <Image src={advisor.imageSrc} ... /> would go here.
                */}
                <div className="absolute inset-0 flex items-center justify-center text-neutral-300">
                   {/* Placeholder Logic: If src exists try to load, else gray box */}
              ...
              <div className="flex flex-col">
                <div className="flex justify-between items-start">
                   <h4 className="font-bold text-black text-sm md:text-base leading-tight pr-2">
                     {advisor.name}
                   </h4>
                ...
                <div className="mt-2 min-h-[2rem]">
                   {Array.isArray(advisor.role) ? (
                     advisor.role.map((r, i) => (
                       <p key={i} className="text-xs font-normal text-neutral-500 leading-tight">
                         {r}
                       </p>
                     ))
                   ) : (
                     <p className="text-xs font-normal text-neutral-500 leading-tight">
                       {advisor.role}
                     </p>
                   )}
                </div>
