    ...
    <section>
      <div className="mx-auto max-w-[1440px] p-4 py-10 md:py-20 px-4 md:px-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-4 lg:gap-6 max-w-8xl mx-auto">
          {/* Top Row: 3 Cards */}
          <div className="col-span-1 md:col-span-2 bg-[#f1f0ec] rounded-2xl p-8 lg:p-10 flex flex-col items-center text-center">
            <div className="mb-6 h-16 w-16 flex items-center justify-center bg-white rounded-2xl shadow-sm">
              ...
              >
                ...
                />
                <path
                  d="M14 9C14 7.5 13 6.5 13 5M10 9C10 7.5 11 6.5 11 5"
                  stroke="#e55a40"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                />
          ...
          {/* Bottom Row: 2 Cards */}
          <div className="col-span-1 md:col-span-3 bg-[#f1f0ec] rounded-2xl p-8 lg:p-10 flex flex-col items-center text-center">
            <div className="mb-6 h-16 w-16 flex items-center justify-center bg-white rounded-2xl shadow-sm">
              <svg
                width="40"
                height="40"
              ...
              >
                ...
                />
                <path
                  d="M17 10v6l-5 14a2 2 0 0 0 2 3h12a2 2 0 0 0 2-3l-5-14v-6"
                  stroke="#333"
                  strokeWidth="1.5"
                  strokeLinejoin="round"
                />
                ...
                <path
                  d="M25 28c0 1.65 1.35 3 3 3s3-1.35 3-3"
                  stroke="#e55a40"
                  strokeWidth="1.5"
          ...
          <div className="col-span-1 md:col-span-3 bg-[#f1f0ec] rounded-2xl p-8 lg:p-10 flex flex-col items-center text-center">
            <div className="mb-6 h-16 w-16 flex items-center justify-center bg-white rounded-2xl shadow-sm">
              ...
              >
                <path
                  d="M16 10v12a4 4 0 0 0-2 3.5c0 2 1.5 3.5 3.5 3.5h5c2 0 3.5-1.5 3.5-3.5a4 4 0 0 0-2-3.5v-12a2.5 2.5 0 0 0-5 0v0Z"
                  stroke="#333"
                  strokeWidth="1.5"
                  strokeLinejoin="round"
                />
          ...
          <div className="flex gap-4 overflow-x-auto pb-8 snap-x snap-mandatory scrollbar-hide -mx-6 px-6 md:mx-0 md:px-0 md:grid md:grid-cols-3  md:gap-6 md:pb-0 md:overflow-visible">
            ...
            <div className="flex-shrink-0 w-[85vw] sm:w-[60vw] md:w-auto snap-start relative overflow-hidden rounded-2xl border border-neutral-200 bg-white p-6 flex flex-col items-center text-center transition-all duration-300 hover:scale-105 hover:shadow-lg hover:z-10">
              ...
              <div className="mb-4 h-12 flex items-center justify-center">
                ...
                >
                  <path
                    d="M16 6L24 14L16 26L8 14L16 6Z"
                    stroke="#333"
                    strokeWidth="1.5"
                    strokeLinejoin="round"
                  />
            ...
            <div className="flex-shrink-0 w-[85vw] sm:w-[60vw] md:w-auto snap-start relative overflow-hidden rounded-2xl border border-neutral-200 bg-white p-6 flex flex-col items-center text-center transition-all duration-300 hover:scale-105 hover:shadow-lg hover:z-10">
              ...
              <div className="mb-4 h-12 flex items-center justify-center">
                ...
                >
                  ...
                  />
                  <path
                    d="M6 16v2c0 3 4 6 10 6s10-3 10-6v-2"
                    stroke="#333"
                    strokeWidth="1.5"
                  />
