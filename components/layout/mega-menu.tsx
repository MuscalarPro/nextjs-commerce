...
export default function MegaMenu() {
  return (
    <motion.div
      ...
      className="fixed top-20 left-1/2 -translate-x-1/2 mt-2 w-[min(80rem,calc(100vw-2rem))] bg-white rounded-3xl overflow-hidden shadow-2xl z-[100] border border-neutral-100"
    >
