      ...
      <div className="relative z-10 mx-auto max-w-[1440px] px-4 md:px-2">
        ...
        <div className="relative w-full h-auto md:h-[600px] rounded-2xl overflow-hidden bg-white/10 backdrop-blur-[40px] border border-white/20 shadow-2xl flex flex-col md:flex-row items-center">
          ...
          <div className="relative z-20 w-full md:w-1/2 p-8 md:p-16 flex flex-col justify-center h-full text-white">
            ...
            <p className="text-[10px] md:text-xs text-white/60 max-w-lg   ">
              <br />
              <i className="opacity-70 text-[9px] mt-1 block">
                *Shown in randomized, double‑blind, placebo‑controlled human
                trials of Urolithin A, measuring mitochondrial renewal and
                muscle performance in middle‑aged adults. [jamanetwork]
              </i>
            </p>
          ...
          <div className="relative z-20 w-full md:w-1/2 h-full min-h-[400px] flex flex-col md:flex-row items-center justify-center p-4 md:p-8 gap-8 md:gap-8">
            ...
            <div className="md:hidden flex flex-col items-center text-center w-full mt-[-20px]">
              <p className="text-sm font-medium text-white mb-6     max-w-[250px]">
                These cellular batteries power how long and how well you live.
              </p>
