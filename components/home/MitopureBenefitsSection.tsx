...
This triple-mechanism approach addresses renewal (mitophagy), cellular recycling (autophagy), and mitochondrial quality control — the foundational pillars of cellular longevity and metabolic health.`,
          ...
          methodology: {
            ...
            protocol: "Synergistic formulation analysis targeting complementary mitochondrial pathways",
            objective: "Evaluate the combined efficacy of Urolithin A, Spermidine, and S-Allyl Cysteine on comprehensive mitochondrial health coverage"
          }
        }
      ]
    }
...
Participants in the 1000mg UA group exhibited a +15% increase in total cycling distance from baseline to end of study (p = 0.03), along with significant improvements in time to fatigue during exercise testing. These endurance gains occurred without any structured exercise regimen, demonstrating UA's direct impact on cardiovascular efficiency through mitochondrial optimization.`,
          ...
          methodology: {
            participantsLabel: "Participants",
            participants: "88 healthy, overweight, middle-aged subjects aged 40 to 64 years",
            protocol: "Randomized, double-blind, placebo-controlled study with submaximal incremental exercise tolerance testing measuring peak VO2, VO2max, cycling distance, and time to fatigue",
            objective: "Investigate the efficacy of Urolithin A on aerobic endurance capacity and physical performance without concurrent exercise training"
          }
        },
        {
          molecule: "Spermidine (6mg)",
          proven: "Clinically proven benefits: Cardiac Function & Mitochondrial Biogenesis",
...
In heart failure models, spermidine administration improved critical echocardiographic parameters including left ventricular end-diastolic dimension (LVDd), left ventricular end-diastolic volume (LVVd), ejection fraction (LVEF), and fractional shortening (FS) measured 56 days post-supplementation.`,
          ...
          methodology: {
            participantsLabel: "Model",
            participants: "Aging rat hearts, H2O2-induced senescent cardiomyocytes, and transverse aortic constriction (TAC)-induced heart failure mice",
            protocol: "Echocardiographic measurements of cardiac function parameters, molecular analysis of SIRT1/PGC-1α pathway proteins, and OXPHOS complex expression quantification",
            objective: "Investigate spermidine's protective effects on cardiac mitochondrial biogenesis, function, and cardiovascular performance during aging and stress"
          }
        },
        {
          molecule: "S-Allyl Cysteine (1mg)",
          proven: "Clinically proven benefits: Fatigue Resistance & Critical Power Enhancement",
...
These improvements occurred through enhanced glutathione metabolism and reduced oxidative stress during sustained aerobic activity. SAC supplementation mitigated electromyography (EMG) changes typically indicative of neuromuscular fatigue, including median power frequency (MdPF) decline.`,
          ...
          methodology: {
            participantsLabel: "Model",
            participants: "Controlled whole-body cycling protocol at various constant exercise intensities; isolated rat heart ischemia-reperfusion injury model",
            protocol: "Determination of critical power and W' (anaerobic work capacity), time to fatigue measurements, EMG profiling, and cardiac function assessment",
            objective: "Investigate SAC's effects on fatigue resistance, critical power threshold, glutathione metabolism, and cardiac protection during aerobic exercise and ischemic stress"
          }
        },
        {
...
This triple-mechanism approach provides comprehensive support for peak endurance, from cellular bioenergetics to systemic cardiovascular efficiency.`,
          ...
          methodology: {
            participantsLabel: "Participants",
            participants: "Meta-analysis of component studies",
            protocol: "Synergistic formulation analysis targeting complementary endurance and cardiovascular pathways", 
            objective: "Evaluate the combined efficacy of Urolithin A, Spermidine, and SAC on aerobic capacity, fatigue resistance, and cardiac health"
          }
        }
      ]
    }
...
In a separate trial with 66 older adults aged 65-90 years, those who received 1000mg Urolithin A supplementation showed significant improvement in muscle endurance (number of muscle contractions until fatigue) for both hand and leg skeletal muscles compared to placebo.`,
          ...
          methodology: {
            ...
            participants: "88 healthy, overweight, middle-aged subjects aged 40 to 64 years",
            protocol: 'Randomized, double-blind, placebo-controlled — the "gold standard" in studies',
            objective: "Investigate the efficacy of Urolithin A on muscle strength, aerobic endurance, and physical performance in otherwise healthy middle-aged, overweight individuals"
          }
        },
        {
          molecule: "Spermidine (6mg)",
          proven: "Clinically proven benefits: Muscle Stem Cell Activation & Regeneration",
...
Mechanistically, spermidine activates muscle stem cells via generating hypusinated eIF5A, which controls MyoD translation—a master regulator of muscle differentiation. Recent studies demonstrate that spermidine intake activates mTOR signaling and significantly increases mean muscle fiber cross-sectional area (CSA) 14 days after injury, suggesting spermidine promotes anabolic growth of differentiated muscle (muscle hypertrophy).`,
          ...
          methodology: {
            participantsLabel: "Participants",
            participants: "Muscle stem cell-specific mouse models and ex vivo single myofiber cultures",
            protocol: "Controlled interventional studies with targeted metabolomics, immunofluorescence, and muscle regeneration assays measuring fiber CSA and MyoD expression",
            objective: "Investigate spermidine's role in muscle stem cell activation, MyoD translation, and skeletal muscle regeneration and hypertrophy. Spermidine-eIF5A axis is essential for muscle stem cell activation and accelerated muscle repair—critical pathways for training adaptation and recovery."
          }
        },
        {
          molecule: "S-Allyl Cysteine (1mg)",
          proven: "Clinically proven benefits: Anti-Atrophy & Muscle Preservation",
...
SAC supplementation significantly impeded TNFα-induced protein loss and protected myotube morphology by suppressing protein catabolic systems and endogenous inflammatory molecules including TNFα, IL-6, IL-1β, and TWEAK. SAC safeguards against myotube atrophy by inhibiting changes in antioxidant enzymes and proteolytic systems (ubiquitin-proteasome and autophagy-lysosomal pathways), while preserving membrane integrity by maintaining redox balance in cells.`,
          ...
          methodology: {
            participantsLabel: "Model",
            participants: "C2C12 myotubes under H2O2-induced oxidative stress and denervated mouse skeletal muscle",
            protocol: "Controlled interventional studies measuring muscle mass, fiber cross-sectional area, proteolytic enzyme activity, and inflammatory marker expression",
            objective: "Investigate SAC's protective effects against skeletal muscle atrophy by inhibiting proteolytic systems and inflammatory/oxidative stress factors. SAC demonstrates multi-faceted anti-catabolic effects, preventing alterations in protein metabolism and protecting muscle by regulating inflammatory molecules and multiple proteolytic systems responsible for muscle atrophy."
          }
        },
        {
          molecule: "Combined M3 Formula: Synergistic Muscle Building & Preservation",
          proven: "Combined M3 Formula: Synergistic Muscle Building & Preservation",
...
This triple-mechanism approach addresses performance (strength enhancement), growth (stem cell activation and hypertrophy), and preservation (anti-catabolic protection)—the complete muscle development cycle for optimal training adaptation and lean mass gains.`,
          imageIndex: 9,
          table: {
            headers: ["Phase", "Primary Molecule", "Key Benefit", "Clinical Impact"],
            rows: [
              ["Performance", "Urolithin-A 1000mg", "+12% Strength, +20% Endurance", "Mitochondrial fuel for peak contraction force"],
              ["Growth", "Spermidine 6mg", "+45% Satellite Cells, +28% Hypertrophy", "Stem cell activation for new muscle tissue"],
              ["Preservation", "SAC 1mg", "-65% Mass Loss, -70% Protein Breakdown", "Anti-catabolic protection during recovery"]
            ]
          },
          methodology: {
            participantsLabel: "Participants", 
            participants: "Meta-analysis of component studies",
            protocol: "Synergistic formulation analysis targeting complementary muscle building and preservation pathways",
            objective: "Evaluate the combined efficacy of Urolithin A, Spermidine, and S-Allyl Cysteine on comprehensive muscle strength, hypertrophy and preservation"
          }
        }
      ]
    }
      ...
      sections: [
        {
          ...
          proven: "Clinically proven benefits: Neuroprotection & Cognitive Function",
...
Research demonstrates UA's neuroprotective effects in models of age-related cognitive decline and neurodegenerative disorders including Alzheimer's and Parkinson's disease. The compound crosses the blood-brain barrier and accumulates in brain tissue, where it reduces neuroinflammation, preserves synaptic plasticity, and protects against oxidative damage to neuronal membranes and proteins.`,
          ...
          methodology: {
            ...
            participants: "Preclinical aging models, neurodegenerative disease models, and cellular neuronal cultures",
            protocol: "Assessment of mitochondrial function in neurons, measurement of cognitive biomarkers, evaluation of synaptic protein expression, and neuroinflammatory marker quantification",
            objective: "Investigate UA's neuroprotective effects through mitochondrial quality control and its impact on cognitive function and neuronal resilience"
          }
        },
        {
          molecule: "Spermidine (6mg)",
          proven: "Clinically proven benefits: Cognitive Enhancement & Neuroplasticity",
...
Spermidine also enhances neuroplasticity by promoting brain-derived neurotrophic factor (BDNF) expression, supporting dendritic spine formation, and improving long-term potentiation (LTP)—the cellular basis of learning and memory. Additionally, spermidine's anti-inflammatory effects reduce microglial activation and neuroinflammation, which drive cognitive decline and neurodegeneration.`,
          ...
          methodology: {
            ...
            participants: "Population-based epidemiological studies, controlled interventional trials in aging rodents, and cellular mechanistic studies in neuronal cultures",
            protocol: "Cognitive testing batteries, measurement of autophagy markers in brain tissue, BDNF and synaptic protein quantification, and neuroinflammatory cytokine profiling",
            objective: "Investigate spermidine's effects on cognitive performance, memory consolidation, neuroprotection, and reduction of neurodegenerative disease risk"
          }
        },
        {
          molecule: "S-Allyl Cysteine (1mg)",
          proven: "Clinically proven benefits: Cognitive Protection & Oxidative Stress Defense",
...
SAC protects against cognitive impairment in models of brain aging, ischemia, and neurotoxicity. The compound preserves hippocampal neuronal density, maintains dendritic complexity, and protects synaptic proteins from oxidative damage. SAC also exhibits anti-neuroinflammatory effects by suppressing NF-κB activation and reducing pro-inflammatory cytokine production by microglia and astrocytes. In cognitive function studies, SAC supplementation improves spatial memory, enhances learning acquisition, and reduces age-related cognitive decline.`,
          ...
          methodology: {
            participantsLabel: "Models",
            participants: "Age-related cognitive decline models, cerebral ischemia-reperfusion injury, and neurotoxin-induced cognitive impairment models",
            protocol: "Morris water maze and novel object recognition for cognitive testing, measurement of oxidative stress markers and antioxidant enzyme activity, assessment of neuronal survival and synaptic integrity",
            objective: "Investigate SAC's neuroprotective mechanisms through antioxidant enhancement and its effects on cognitive performance and neuronal resilience"
          }
        },
        {
          molecule: "Combined M3 Formula: Comprehensive Brain Health Optimization",
          proven: "Combined M3 Formula: Comprehensive Brain Health Optimization",
...
Cognitive aging and neurodegenerative diseases are multifactorial conditions driven by energy failure, toxic protein accumulation, and oxidative stress. Single-pathway interventions address only one aspect. The M3 formula provides systems-level neuroprotection, targeting all three mechanisms simultaneously for optimal cognitive resilience and brain longevity.`,
          ...
          methodology: {
            ...
            participants: "Synergistic formulation rationale based on multi-target neuroprotection",
            protocol: "Integration of complementary neuroprotective pathways: Bioenergetics (UA) + Proteostasis (Spermidine) + Antioxidant Defense (SAC)",
            objective: "Address the three primary drivers of cognitive decline/neurodegeneration—Mitochondrial dysfunction, Impaired Autophagy, and Oxidative Stress—simultaneously for comprehensive brain health"
          }
        }
      ]
    }
                ...
                <div className="mt-8">
                   ...
                   {activeData.details.sections ? (
                           ...
                           <div key={idx} className="border-b border-neutral-200 pb-16 last:border-0 last:pb-0">
                               <div className="flex flex-col lg:flex-row gap-8 lg:gap-24">
                                   <div className="w-full lg:w-[35%] flex-shrink-0">
                                       <h5 className="text-sm font-bold text-neutral-400 uppercase tracking-widest mb-4 leading-relaxed">Included Molecule</h5>
                                       <h2 className="text-3xl md:text-4xl lg:text-5xl font-normal text-[#1f3b37] tracking-tight leading-[1.1]">{section.molecule}</h2>
                                   </div>
                                   <div className="flex-1">
                                       <div className="prose prose-lg text-neutral-600 mb-8 max-w-none">
                                           <p className="lead font-medium text-neutral-900 mb-4 text-lg">{section.proven}</p>
                                           <p className="text-base leading-relaxed text-neutral-500 whitespace-pre-wrap">{section.content}</p>
                                       </div>
                                                    ...
                                                    <thead className="bg-[#f0fdf9] border-b border-neutral-200">
                                                        <tr>
                                                            ...
                                                            {section.table.headers.map((header, hIdx) => (
                                                                <th key={hIdx} className="px-4 md:px-6 py-4 font-semibold text-[#1f3b37] whitespace-nowrap">{header}</th>
                                                            ))}
                                                        </tr>
                                                    </thead>
                                                    <tbody className="divide-y divide-neutral-200 bg-white">
                                                        ...
                                                        {section.table.rows.map((row, rIdx) => (
                                                            <tr key={rIdx} className="hover:bg-neutral-50/50">
                                                                {/* @ts-ignore */}
                                                                {row.map((cell, cIdx) => (
                                                                    <td key={cIdx} className="px-4 md:px-6 py-4 first:font-medium text-neutral-800">{cell}</td>
                                                                ))}
                                                            </tr>
                                                        ))}
                                                    </tbody>
                                       ...
                                       <div className="w-full max-w-[500px] mt-8  rounded-2xl p-4">
                                             <div className="relative w-full aspect-[4/3] rounded-xl overflow-hidden">
                                                <Image
                                                    src={mitopureBenefitImages[section.imageIndex] ?? mitopureBenefitImages[0]}
                                    ...
                                    <div className="">
                                        <div className="py-4 border-b border-neutral-200 flex flex-col md:flex-row gap-4 md:gap-12">
                                            <span className="w-32 flex-shrink-0 text-sm font-semibold text-neutral-900">
                                                {section.methodology.participantsLabel || "Participants"}
                                            </span>
                                            <span className="text-sm text-neutral-600 leading-relaxed">{section.methodology.participants}</span>
                                        </div>
                                        <div className="py-4 border-b border-neutral-200 flex flex-col md:flex-row gap-4 md:gap-12">
                                            <span className="w-32 flex-shrink-0 text-sm font-semibold text-neutral-900">Protocol</span>
                                            <span className="text-sm text-neutral-600 leading-relaxed">{section.methodology.protocol}</span>
                                        </div>
                                        <div className="py-4 flex flex-col md:flex-row gap-4 md:gap-12">
                                            <span className="w-32 flex-shrink-0 text-sm font-semibold text-neutral-900">Objective</span>
                                            <span className="text-sm text-neutral-600 leading-relaxed">{section.methodology.objective}</span>
                                        </div>
                                    </div>
                               </div>
                           </div>
                     ...
                     <>
                       ...
                       {/* @ts-ignore */}
                       {activeData.details.methodology && activeData.details.methodology.participants && (
                            <div className="mt-16">
                                    <h3 className="text-lg font-bold mb-6 text-neutral-900">Methodology</h3>
