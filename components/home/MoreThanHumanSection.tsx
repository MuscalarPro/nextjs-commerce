      ...
      <div className="mx-auto max-w-[1440px] px-4 md:px-2">
        <div className="grid gap-2 md:grid-cols-2 md:items-center md:gap-12">
          <div className="space-y-4 md:space-y-8">
            <h2 className="text-[1.5rem] md:text-[36px] text-[#1a3319] font-semibold text-center md:text-left">
              Decoding Peak Human Performance​
            </h2>

            <p className="text-[0.8rem] md:text-[1rem] text-neutral-700    max-w-2xl text-center md:text-left mx-auto md:mx-0">
