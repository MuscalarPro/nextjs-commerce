...
export function WeightLossSection() {
  ...
  return (
    <section className="w-full flex flex-col gap-0 overflow-hidden bg-[#201C21]">
      ...
      <div className="relative w-full overflow-hidden min-h-[700px] md:min-h-[700px] flex flex-col items-center justify-between pt-16 pb-12">
        ...
        <motion.div
          ...
          className="absolute top-[40%] right-[25%] md:right-[30%] bg-white/20 backdrop-blur-md border border-white/30 p-6 rounded-2xl md:rounded-3xl text-white shadow-xl min-w-[160px]"
        >
          ...
          <div className="flex flex-col gap-2 max-w-6xl mx-auto ">
            ...
            <div className="relative w-full rounded-2xl md:rounded-3xl bg-white/10 backdrop-blur-md overflow-hidden min-h-[500px] group ">
              ...
              <div className="absolute bottom-2 left-1/2 -translate-x-1/2 md:translate-x-0 md:left-auto md:right-8 md:bottom-2 z-20 block">
                <button
                  onClick={() => setSelectedFeature("GLP-1 injections")}
                  className="px-6 py-3 rounded-full text-black text-sm font-semibold backdrop-blur-md bg-white/100 hover:bg-white transition-all"
                >
                  Learn more
                </button>
              </div>
