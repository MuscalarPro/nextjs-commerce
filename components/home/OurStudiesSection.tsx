      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-start justify-between gap-12 lg:flex-row lg:items-end">
          <div className="max-w-2xl">
            ...
            <h2 className="mb-6 font-serif text-4xl font-normal text-neutral-900 sm:text-5xl md:text-6xl">
              15+ years of research
            </h2>
            <p className="max-w-lg text-lg leading-relaxed text-neutral-600 sm:text-xl">
              Our products are backed by rigorous scientific studies. We believe in transparency and validating our efficacy through peer-reviewed research.
            </p>
          </div>
        ...
        <div className="mt-20 border-t border-neutral-200 pt-10">
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-12 gap-y-8 grayscale opacity-60">
             ...
             <span className="text-xl font-serif font-bold text-neutral-800">Nature Metabolism</span>
             <span className="text-xl font-serif font-bold text-neutral-800">JAMA Network Open</span>
             <span className="text-xl font-serif font-bold text-neutral-800">Cell Reports</span>
             <span className="text-xl font-serif font-bold text-neutral-800">Nature Aging</span>
             <span className="text-xl font-serif font-bold text-neutral-800">European Heart Journal</span>
          </div>
        </div>
      </div>
    </section>
