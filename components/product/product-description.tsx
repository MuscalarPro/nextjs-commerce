...
export function ClinicalResearchButton({
  ...
  return (
    ...
    >
      <div
        className={`flex h-6 w-6 items-center justify-center rounded-full border ${borderColor} ${textColor}`}
      >
        <span className="text-xs">+</span>
      </div>
...
export function ProductDescription({ product }: { product: Product }) {
  ...
  const [selectedTestingId, setSelectedTestingId] = useState<string | null>(
    null,
  );
  ...
  useEffect(() => {
    ...
    return () =>
      window.removeEventListener("openRigorousTesting", handleOpenOverlay);
  }, []);
  ...
  useEffect(() => {
    ...
    window.addEventListener(
      "openClinicalResearch1",
      handleOpenClinicalResearch1,
    );
  ...
  return (
    <>
      ...
      <div className="mb-2">
        ...
        <div className="mt-8 rounded-3xl p-6 border-neutral-100">
          ...
          <SubscriptionOptions
            selectedIndex={
              purchaseMode === "subscription" ? selectedSubscriptionIndex : -1
            }
            onSelect={(index) => {
          ...
          <div className="space-y-4 px-2">
            <div className="flex items-center gap-3 text-sm text-neutral-600">
              ...
              <span className="font-base tracking-tight">
                ...
                <span className="underline decoration-neutral-200 underline-offset-4 cursor-pointer hover:text-black transition-colors">
            ...
            <div className="overflow-hidden">
              <div className="mt-3 pb-3">
                <p className="text-[16px] text-black mb-6 leading-relaxed">
                  After years of precision research and double-blind RCTs on
                  Urolithin A, M3 targets aging at its root: mitochondrial
                  decay.
                  <button
                ...
                <div className="space-y-6 mb-6">
                  <div className="flex items-start gap-4">
                    ...
                    <p className="text-[16px] text-black">
                      <span className="font-bold">Endurance:</span> +41%
                      improvement in contractions-to-fatigue*
                    </p>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="h-6 w-1 bg-black shrink-0 mt-1" />
                    <p className="text-[16px] text-black">
                      <span className="font-bold">Muscle strength:</span> +12%
                      gain after 16 weeks in clinical trials*
                    </p>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="h-6 w-1 bg-black shrink-0 mt-1" />
                    <p className="text-[16px] text-black">
                      <span className="font-bold">Recovery:</span> -40%
                      inflammation (CRP) after 4 months*
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="overflow-hidden">
              <div className="mt-3 pb-3">
                <div className="space-y-8 mb-10">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                        <span className="bg-[#5B4FCB] text-white text-[10px] font-bold px-1.5 py-0.5 rounded leading-none">
                          M3
                        </span>
                      ...
                      <p className="text-[14px] text-neutral-600 leading-relaxed">
                        The mitochondria rebuilder. Clinically proven to improve
                        muscle endurance and cellular energy in adults over 40.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-[14px] text-neutral-600 leading-relaxed">
                        The cellular housekeeper. Triggers autophagy to clear
                        damaged proteins and keep cells running clean.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-[14px] text-neutral-600 leading-relaxed">
                        The antioxidant shield. Boosts glutathione to protect
                        muscle and brain tissue under training stress.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="border-t border-neutral-100 pt-8 mb-10">
                  <h4 className="text-[15px] font-bold text-black mb-6">
                    Clean formulation:
                  </h4>
            ...
            <div className="overflow-hidden">
              <div className="mt-3 pb-3">
                <p className="text-[16px] text-black leading-relaxed">
                  Take two vegan capsules daily, with or without food, morning
                  or night. Each bottle lasts one month at the clinically
                  studied dose of 1,000mg Urolithin A per day. M3 is
                  stimulant-free and has no known interactions with common
                  supplements like creatine, whey, or omega-3s.
                </p>
              </div>
            </div>
          </div>
                  ...
                  <div className="p-6 space-y-8">
                    ...
                    <section>
                      ...
                      <p className="text-sm    text-black md:text-base">
                        ...
                        placebo-controlled clinical trials (DBRCTs).
                      </p>
                      <p className="mt-3 text-sm    text-black md:text-base">
                        Muscalar Pro M3’s hero ingredient, Urolithin A, is
                        supported by multiple DBRCTs in older and middle‑aged
                        adults demonstrating improvements in muscle endurance
                        and biomarkers of mitochondrial health.
                      </p>
                    ...
                    <section>
                      ...
                      <p className="text-sm    text-black md:text-base">
                        ...
                        (randomization + blinding), control for placebo effects,
                        and test real‑world outcomes with predefined endpoints.
                      </p>
                      <p className="mt-3 text-sm    text-black md:text-base">
                    ...
                    <section>
                      ...
                      <p className="text-sm    text-black md:text-base">
                        M3 supports endurance capacity by targeting
                        mitochondrial quality control (mitophagy), which is
                        mechanistically linked to fatigue resistance in aging
                        muscle.
                      </p>
                      ...
                      <p className="text-sm    text-black md:text-base">
                        ...
                        Urolithin A, muscle endurance (contractions until
                        fatigue) improved at 2 months in both hand muscle (FDI:
                        95.3 vs 11.6 placebo) and leg muscle (TA: 41.4 vs 5.7
                        placebo).
                      </p>
                      <div className="mt-3 flex flex-wrap gap-2">
                        <ExternalLinkPill
                      ...
                      <p className="mt-3 text-sm    text-black md:text-base">
                        ...
                        baseline in both groups (mean +60.8 m Urolithin A vs
                        +42.5 m placebo), with the between‑group difference not
                    ...
                    <section>
                      ...
                      <p className="text-sm    text-black md:text-base">
                        ...
                        measurable performance (strength output and endurance
                        under load).
                      </p>
                      <h4 className="mt-3 mb-2 text-base font-semibold text-black md:text-lg">
                        Clinical trial results
                      ...
                      <p className="mt-3 text-sm    text-black md:text-base">
                        ...
                        placebo‑controlled study in resistance‑trained male
                        athletes (1 g/day Urolithin A), the authors report
                        improvements in muscle strength and endurance, alongside
                        changes in inflammation and oxidative stress measures.
                      </p>
                      <div className="mt-3 flex flex-wrap gap-2">
                        <ExternalLinkPill
                    ...
                    <section>
                      ...
                      <p className="text-sm    text-black md:text-base">
                        Urolithin A is a mitophagy activator, while Spermidine
                        is classically studied as an autophagy‑supportive
                        polyamine; together they map to “clean → rebuild”
                        cellular maintenance biology.
                      </p>
                      <p className="mt-3 text-sm    text-black md:text-base">
                        In older adults, Urolithin A supplementation decreased
                        circulating biomarkers associated with mitochondrial and
                        metabolic stress (acylcarnitines, ceramides) and reduced
                        CRP relative to placebo.
                      </p>
                      <div className="mt-3 flex flex-wrap gap-2">
                        <ExternalLinkPill
                          href="https://jamanetwork.com/journals/jamanetworkopen/fullarticle/2788244"
                      ...
                      <p className="text-sm    text-black md:text-base">
                        Spermidine has evidence in human‑cell models for
                        rescuing bioenergetic and mitophagy deficits,
                      </p>
                      <div className="mt-3 flex flex-wrap gap-2">
                        <ExternalLinkPill
                    ...
                    <section>
                      ...
                      <p className="text-sm    text-black md:text-base">
                        ...
                        (autophagy signaling) plus antioxidant neuroprotection
                        to support resilience under stress.
                      </p>
                      <h4 className="mt-3 mb-2 text-base font-semibold text-black md:text-lg">
                        Clinical / translational evidence
                      </h4>
                      <p className="text-sm    text-black md:text-base">
                        In a 12‑month randomized clinical trial in older adults
                        with subjective cognitive decline, spermidine
                        supplementation did not significantly improve the
                        primary memory outcome vs placebo, though exploratory
                        analyses suggested possible effects on inflammation and
                        verbal memory that require validation.
                      </p>
                      <div className="mt-3 flex flex-wrap gap-2">
                        <ExternalLinkPill
                          href="https://jamanetwork.com/journals/jamanetworkopen/fullarticle/2792725"
    ...
    "
                      ...
                      <p className="mt-3 text-sm    text-black md:text-base">
                        ...
                        effects in mouse models with reductions in oxidative
                        stress markers in the hippocampus.
                      </p>
                      ...
                      <p className="mt-3 text-sm    text-black md:text-base">
                        The RCT outcomes above are from trials of Urolithin A as
                        an ingredient; the combined finished M3 formula has not
                        been presented here as being tested as a single product
                    ...
                    <div className="space-y-4">
                        ...
                        {({ open }) => (
                          <div className="border-t border-black/10 py-6">
                            <Disclosure.Button className="flex w-full items-center justify-between group py-2">
                              <h3 className="text-[13px] font-bold tracking-[0.2em] uppercase text-neutral-600 group-hover:text-black transition-colors">
                                Active Molecules
                              </h3>
                              <span
                                className={`text-2xl font-light transition-transform duration-300 ${open ? "rotate-45" : "rotate-0"}`}
                              >
                                +
                              </span>
                            </Disclosure.Button>
                              ...
                              <Disclosure.Panel className="mt-8 space-y-12">
                                ...
                                <div className="group">
                                  <div className="flex items-baseline justify-between mb-4">
                                    ...
                                    <span className="px-3 py-1 rounded-full border border-black/10 text-[11px] font-bold uppercase tracking-wider text-neutral-500">
                                      1,000 mg
                                    </span>
                                  </div>
                                  <div className="space-y-3 text-[14px] leading-relaxed text-neutral-600">
                                    <p>
                                      ...
                                      Purified via microbial fermentation from
                                    ...
                                    <p>
                                      ...
                                      Activates mitophagy — the cellular cleanup
                                      process that clears damaged mitochondria
                                      so healthy ones can take over.
                                    </p>
                                    <p>
                                      <span className="text-black mr-2">
                                        Primary evidence:
                                ...
                                <div className="group">
                                  ...
                                  <div className="space-y-3 text-[14px] leading-relaxed text-neutral-600">
                                    ...
                                    <p>
                                      ...
                                      Induces autophagy — the cell’s
                                      protein-recycling system that slows with
                                      age, allowing damaged proteins to
                                    ...
                                    <p>
                                      ...
                                      2018 (mechanistic review); Kiechl et al.,{" "}
                                      <span className="italic">
                                        Am J Clin Nutr
                                      </span>{" "}
                                      2018 (human observational).
                                    </p>
                                  </div>
                                </div>
                                ...
                                <div className="group">
                                  ...
                                  <div className="space-y-3 text-[14px] leading-relaxed text-neutral-600">
                                    <p>
                                      ...
                                      Aged garlic extract (standardized for SAC
                                      content).
                                    </p>
                                    <p>
                                      <span className="text-black mr-2">
                                      ...
                                      Activates Nrf2, the body's master
                                      transcription-factor for antioxidant
                                      defense. Supports resilience to
                                      training-induced oxidative stress.
                                    </p>
                                    <p>
                                      <span className="text-black mr-2">
                                        Primary evidence:
                                      ...
                                      Ried et al.,{" "}
                                      <span className="italic">Nutrition</span>{" "}
                                      2018 (athlete population, aged garlic
                                      extract).
                                    </p>
                                  </div>
                                </div>
                            ...
                            >
                              <Disclosure.Panel className="mt-8 space-y-6 text-[14px] leading-relaxed text-neutral-600">
                                <p>
                                  ...
                                  plant-derived, size 00, opaque white.
                                  Vegetarian and non-GMO.
                                </p>
                                <p>
                                  Dissolution occurs in the stomach within
                                  approximately 10 minutes. All three active
                                  molecules are stable at gastric pH, so no
                                  enteric coating is required.
                                </p>
                                <p>
                                  We do not make a general-case claim about how
                                  much of "standard supplements" is lost in
                                  digestion. That number depends on the specific
                                  molecule, not on the capsule. For M3,
                                  pharmacokinetic data on Urolithin A
                                  supplementation shows consistent plasma
                                  exposure; see citations in the Active
                                  Molecules section.
                                </p>
                              </Disclosure.Panel>
                            </Transition>
                            ...
                            >
                              <Disclosure.Panel className="mt-8 space-y-4 text-[14px] leading-relaxed text-neutral-600">
                                <p>
                                  ...
                                  — plant-fiber-derived filler. Ensures uniform
                                  capsule fill.
                                </p>
                                <p>
                                  <span className="text-black font-medium">
                                  ...
                                  — flow agent at less than 0.5% of capsule
                                  weight. Prevents active molecules from
                                ...
                                <p>
                                  ...
                                  — anti-caking agent. Keeps the powdered
                                  actives free-flowing during encapsulation.
                                </p>
                                <p className="pt-4 text-xs font-medium text-neutral-400 italic">
                                  Contains no artificial colors, no artificial
                                  flavors, no artificial fragrances, and no
                      ...
                      <div className="border-t border-black/10 pt-10">
                        <p className="text-[14px] leading-relaxed text-neutral-600 mb-10">
                          Tested by NABL-accredited third-party laboratories for
                          identity, purity, and potency per batch. Each lot is
                          screened against 200+ heavy-metal and pesticide
                          contaminants, microbiological safety panels, and
                          WADA-listed banned substances. Certificates of
                        ...
                        <div className="grid grid-cols-4 gap-y-10 gap-x-4">
                          {[
                            {
                              label: "Non-GMO",
                              icon: "M10 2c-2 2.5-2 5 0 7.5s2 5 0 7.5s-2 5 0 7.5 M14 2c2 2.5 2 5 0 7.5s-2 5 0 7.5s2 5 0 7.5 M3 3l18 18",
                            },
                            {
                              label: "Gluten-free",
                              icon: "M12 2v18 M9 8l3 2 M9 12l3 2 M9 16l3 2 M15 8l-3 2 M15 12l-3 2 M15 16l-3 2 M3 3l18 18",
                            },
                            {
                              label: "Soy-free",
                              icon: "M9 12c0-2.5 1.5-4 3-4s3 1.5 3 4-1.5 4-3 4-3-1.5-3-4z M12 8v8 M9 12h6 M3 3l18 18",
                            },
                            {
                              label: "Dairy-free",
                              icon: "M12 22c4.97-4.97 8-9 8-12.5A8 8 0 0 0 4 9.5c0 3.5 3.03 7.53 8 12.5z M3 3l18 18",
                            },
                            {
                              label: "Sugar-free",
                              icon: "M6 6h12v12H6z M6 10h12 M6 14h12 M10 6v12 M14 6v12 M3 3l18 18",
                            },
                            {
                            ...
                            },
                            {
                              ...
                              icon: "M8 5h8v13a2 2 0 0 1-2 2h-4a2 2 0 0 1-2-2V5z M8 9h8 M10 5V3h4v2 M3 3l18 18",
                            },
                            {
                              label: "Vegetarian",
                              icon: "M12 22c4.97-4.97 8-9 8-12.5A8 8 0 0 0 4 9.5c0 3.5 3.03 7.53 8 12.5z",
                            },
                          ].map((item, idx) => (
                            <div
                              key={idx}
                      ...
                      <div className="border-t border-black/10 pt-10">
                        <p className="text-[12px] leading-relaxed text-neutral-600">
                          In the landmark Urolithin A clinical trial (Singh et
                          al., 2022), a subset of participants did not show a
                          measurable response — in part because approximately
                          40% of adults already produce Urolithin A endogenously
                          from dietary ellagitannins, which reduces the
                          incremental effect of supplementation for that group.
                          M3's evidence base is strongest in adults aged 40 to
                          65; effects in younger adults and in individuals
                          taking immunosuppressant or chemotherapeutic
                          medications are not yet well characterized. If you're
                          managing a medical condition or on prescription
                          medication, please discuss M3 with your physician
                          before starting.
                        </p>
                      </div>
                    </div>
                ...
                <div className="flex-1 overflow-y-auto px-8 pb-12">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start mb-12">
                    ...
                    <div className="space-y-8">
                      <p className="body-[14px] leading-relaxed text-black md:text-[18px]">
                        Musclespan is how long your muscles stay strong, fast,
                        and functional across your lifetime. Unlike lifespan,
                        which counts years, musclespan measures your ability to
                        move, lift, recover, and stay independent — decade after
                        decade.
                      </p>
                      <p className="body-[14px] font-normal leading-relaxed text-black md:text-[18px]">
                        It's governed at the cellular level by the health of
                        your{" "}
                        <span className="italic font-light">mitochondria</span>{" "}
                        — the microscopic engines that power every muscle
                        contraction. When they decline, musclespan declines with
                        them.
                      </p>

                      <h3 className="body-[18px] font-normal leading-tight text-black md:text-[28px] pt-4">
                        Grip strength predicts 25-year mortality risk better
                        than BMI.<sup>1</sup>
                      </h3>
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <p className="text-xs leading-relaxed text-neutral-600 md:text-[13px]">
                        Figure 1. Relative 25-year mortality and disability risk
                        in adults, indexed against the weakest midlife
                        grip-strength tertile. Adults in the strongest tertile
                        had roughly half the risk of those in the weakest —
                        independent of BMI, smoking, and baseline activity
                        level.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="border-t border-black/10 pt-8">
                    ...
                    <p className="text-[11px] leading-relaxed text-neutral-600 max-w-2xl">
                      <span className="font-bold mr-1">1</span> Rantanen T,
                      Guralnik JM, Foley D, et al. Midlife hand grip strength as
                      a predictor of old-age disability.{" "}
                      <span className="italic">JAMA</span>. 1999;281(6):558–560.
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="p-6">
                    ...
                    <div className="mb-10">
                      ...
                      <p className="mb-8 text-base leading-relaxed text-black md:text-lg">
                        Propelled by the unmet need for clinically dosed
                        longevity nutrition in the Indian market, Celagenex
                        Research partnered with Dr. Rajaram Samant to translate
                        two decades of peer-reviewed Urolithin A science into M3
                        — a formulation built for the 40-to-65 adult.
                      </p>
                      ...
                      <div className="space-y-12">
                        ...
                        <div className="relative pl-8 border-l border-black/10">
                          ...
                          <p className="text-[15px] leading-relaxed text-neutral-700">
                            Ryu, Mouchiroud, Andreux et al. publish the first
                            characterization of Urolithin A as a mitophagy
                            activator and{" "}
                            <em className="italic">exercise mimetic</em>{" "}
                            molecule in{" "}
                            <em className="italic">Nature Medicine</em>¹,
                            establishing the compound's mechanism in preclinical
                            models.
                          </p>
                        </div>
                        ...
                        <div className="relative pl-8 border-l border-black/10">
                          ...
                          <p className="text-[15px] leading-relaxed text-neutral-700">
                            Celagenex Research begins work on
                            mitochondrial-health nutraceuticals for the Indian
                            market, focusing on molecules with existing human
                            clinical data rather than novel-compound
                            development.
                          </p>
                        </div>
                        ...
                        <div className="relative pl-8 border-l border-black/10">
                          ...
                          <p className="text-[15px] leading-relaxed text-neutral-700">
                            Andreux, Blanco-Bose, Ryu et al. publish the
                            first-in-human safety and pharmacokinetic study of
                            Urolithin A in{" "}
                            <em className="italic">Nature Metabolism</em>²,
                            establishing the dose-response curve and safety
                        ...
                        <div className="relative pl-8 border-l border-black/10">
                          ...
                          <p className="text-[15px] leading-relaxed text-neutral-700">
                            Two landmark randomized controlled trials on
                            Urolithin A publish in the same year: Singh et al.
                            in <em className="italic">Cell Reports Medicine</em>
                            ³ (middle-aged adults, +12% hamstring strength at 16
                            weeks) and Liu et al. in{" "}
                            <em className="italic">JAMA Network Open</em>⁴
                            (older adults, improved muscle endurance).
                          </p>
                        </div>
                        ...
                        <div className="relative pl-8 border-l border-black/10">
                          ...
                          <p className="text-[15px] leading-relaxed text-neutral-700">
                            Celagenex launches MuscalarPro with the M3 Stack —
                            the first clinically dosed Urolithin A formulation
                            (1,000 mg) available in the Indian market, combined
                            with Spermidine and S-Allyl Cysteine as mechanistic
                            adjuncts.
                          </p>
                        </div>
                        ...
                        <div className="relative pl-8 border-l border-black/10">
                          ...
                          <p className="text-[15px] leading-relaxed text-neutral-700">
                            M3's primary evidence base is four published
                            clinical trials on Urolithin A. Celagenex's
                            translation work continues in cognitive health,
                            cardiovascular function, and post-training recovery
                            in the 40-to-65 Indian adult population.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="mt-12 pt-8 border-t border-black/10">
                      ...
                      <ul className="space-y-4 text-[12px] leading-relaxed text-neutral-500">
                        <li className="flex gap-3">
                          ...
                          <span>
                            Ryu D, Mouchiroud L, Andreux PA, et al. Urolithin A
                            induces mitophagy and prolongs lifespan in C.
                        ...
                        <li className="flex gap-3">
                          ...
                          <span>
                            Andreux PA, Blanco-Bose W, Ryu D, et al. The
                            mitophagy activator urolithin A is safe and induces
                            a molecular signature of improved mitochondrial and
                            cellular health in humans.{" "}
                            <em className="italic">Nature Metabolism</em>.
                            2019;1(6):595–603.
                          </span>
                        </li>
                        <li className="flex gap-3">
                          ...
                          <span>
                            Singh A, D’Amico D, Andreux PA, et al. Urolithin A
                            improves muscle strength, exercise performance, and
                            biomarkers of mitochondrial health in a randomized
                            trial in middle-aged adults.{" "}
                            <em className="italic">Cell Reports Medicine</em>.
                            2022;3(5):100633.
                          </span>
                        </li>
                        <li className="flex gap-3">
                          ...
                          <span>
                            Liu S, D'Amico D, Shankland E, et al. Effect of
                            Urolithin A Supplementation on Muscle Endurance and
                            Mitochondrial Health in Older Adults: A Randomized
                            Clinical Trial.{" "}
                            <em className="italic">JAMA Network Open</em>.
                            2022;5(1):e2144279.
                          </span>
                  ...
                  <div className="space-y-12">
                    <section className="space-y-6">
                      <p className="text-[16px] md:text-[18px] text-neutral-600 leading-relaxed">
                        Exercise triggers cellular adaptations that make muscle
                        stronger and more durable. Some of those adaptations can
                        be activated without the workout — what researchers call{" "}
                        <span className="italic">exercise mimetics</span>. They
                        don&apos;t replace training, but they make the
                        adaptations more accessible as you age and
                        responsiveness to training declines. M3&apos;s three
                        molecules each target a different axis of how muscle
                        grows, recovers, and holds its strength.
                      </p>
                    </section>
                    ...
                    <section className="space-y-10">
                      <div className="space-y-6">
                        <div className="flex items-center gap-4">
                          ...
                          <div className="flex gap-2">
                            <span className="px-2 py-0.5 rounded bg-neutral-100 text-[10px] font-bold tracking-wider text-neutral-500 uppercase">
                              1,000 mg
                            </span>
                            <span className="px-2 py-0.5 rounded bg-[#693979]/10 text-[10px] font-bold tracking-wider text-[#693979] uppercase">
                              PRIMARY
                            </span>
                          </div>
                        </div>
                        <p className="text-[14px] italic text-neutral-500 -mt-4">
                          The exercise mimetic
                        </p>
                        <p className="text-[15px] md:text-[17px] text-neutral-600 leading-relaxed">
                          In a 16-week randomized, placebo-controlled trial in
                          adults 40 to 65, daily supplementation produced up to{" "}
                          <span className="font-bold text-black">
                            +12% hamstring muscle strength
                          </span>{" "}
                          and{" "}
                          <span className="font-bold text-black">
                            +41% skeletal muscle endurance
                          </span>{" "}
                          over placebo — measured in participants whose exercise
                          routines were not modified during the trial. The
                          adaptations track what endurance training produces in
                          younger, responsive muscle.*
                        </p>
                        <ExternalLinkPill
                          href="https://pmc.ncbi.nlm.nih.gov/articles/PMC10049002/"
                      ...
                      <div className="space-y-6">
                        <div className="flex items-center gap-4">
                          ...
                          <div className="flex gap-2">
                            ...
                            <span className="px-2 py-0.5 rounded bg-neutral-100 text-[10px] font-bold tracking-wider text-neutral-400 uppercase">
                              SUPPORTING
                            </span>
                          </div>
                        </div>
                        <p className="text-[14px] italic text-neutral-500 -mt-4">
                          The hypertrophy enabler
                        </p>
                        <p className="text-[15px] md:text-[17px] text-neutral-600 leading-relaxed">
                          Muscle fiber repair and growth require autophagy —
                          damaged contractile proteins must be cleared before
                          new ones can be synthesized. Spermidine&apos;s
                          autophagy-supporting role has been associated with
                          reduced sarcopenia markers in older adults in
                          observational data; direct-strength randomized trials
                          in humans are in progress, not yet conclusive.
                        </p>
                        <ExternalLinkPill
                      ...
                      <div className="space-y-6">
                        ...
                        <p className="text-[14px] italic text-neutral-500 -mt-4">
                          The recovery adjunct
                        </p>
                        <p className="text-[15px] md:text-[17px] text-neutral-600 leading-relaxed">
                          Intense training produces a free-radical load that
                          drives post-exercise soreness and slows day-over-day
                          recovery. Aged garlic extract trials in trained
                          athletes have shown reduced post-exercise
                          oxidative-stress markers — the mechanism attributed to
                          S-Allyl Cysteine&apos;s Nrf2 activation. Faster
                          recovery compounds into more trainable weeks per year.
                        </p>
                        <ExternalLinkPill
                    ...
                    <div className="pt-12 border-t border-black/10">
                      ...
                      <p className="text-[13px] text-neutral-500 leading-relaxed italic">
                        The clinical outcomes presented are derived from
                        randomized, double-blind, placebo-controlled trials of
                        the individual ingredients. The combined formulation
                        leverages these specific dosages to maximize synergistic
                        cellular effects.
                      </p>
                    </div>
                  </div>
                ...
                <div className="flex-1 overflow-y-auto px-6 pb-12 space-y-12">
                  <section className="space-y-6">
                    ...
                    <p className="text-[17px] leading-relaxed text-neutral-700">
                      The dose printed on a bottle and the dose your body
                      actually absorbs are rarely the same number. Stomach acid,
                      digestive enzymes, and oxygen break down most active
                      ingredients before they reach your bloodstream — so a
                      1,000mg label can deliver a fraction of that to the cell.
                    </p>
                    <p className="text-[17px] leading-relaxed text-neutral-700">
                      M3 is formulated to keep each molecule intact through
                      digestion. What the label promises is what your body gets.
                    </p>
                  </section>
                  ...
                  <section className="space-y-6">
                    ...
                    <p className="text-[17px] leading-relaxed text-neutral-700">
                      Each M3 capsule is a plant-based shell designed to protect
                      its contents until they can be absorbed. Think of it as a
                      timed-release envelope for the three active molecules
                      inside.
                    </p>
                    <ul className="space-y-4 pt-2">
                      <li className="flex items-start gap-3">
                        ...
                        <span className="text-[16px] text-neutral-700">
                          Made from plant cellulose — no animal gelatin, no
                          synthetic coatings.
                        </span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="mt-2 h-1 w-1 shrink-0 rounded-full bg-neutral-400" />
                        <span className="text-[16px] text-neutral-700">
                          Shields the molecules from stomach acid and bile.
                        </span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="mt-2 h-1 w-1 shrink-0 rounded-full bg-neutral-400" />
                        <span className="text-[16px] text-neutral-700">
                          Two capsules a day deliver the full clinical dose. No
                          re-dosing, no spreading out through the day.
                        </span>
                      </li>
                    </ul>
                  </section>
                  ...
                  <section className="space-y-6">
                    ...
                    <p className="text-[17px] leading-relaxed text-neutral-700">
                      Two capsules deliver the complete M3 Stack™ at the exact
                      doses studied in human clinical trials:
                    </p>
                    <ul className="space-y-6 pt-2">
                      <li className="flex items-start gap-3">
                        ...
                        <span className="text-[16px] text-neutral-700">
                          ...
                          — the dose used in the JAMA Network Open RCT on
                          middle-aged adults.
                        </span>
                      </li>
                      <li className="flex items-start gap-3">
                        ...
                        <span className="text-[16px] text-neutral-700">
                          ...
                          — the dose shown to support autophagy in controlled
                          human studies.
                        </span>
                      </li>
                      <li className="flex items-start gap-3">
                        ...
                        <span className="text-[16px] text-neutral-700">
                          <strong className="text-black font-semibold">
                            S-Allyl Cysteine · 0.5mg
                          </strong>{" "}
                          — a clinically studied antioxidant derived from aged
                          garlic.
                        </span>
                      </li>
                    </ul>
                    <p className="text-[15px] italic text-neutral-500 pt-4">
                      Take both capsules together, with or without food, at any
                      time of day.
                    </p>
                  </section>
                  ...
                  <section className="space-y-6">
                    ...
                    <p className="text-[17px] leading-relaxed text-neutral-700">
                      Every batch of M3 goes through a standardized testing
                      program before it ships. We verify three things: identity
                      (the molecule is what we say it is), potency (the dose is
                      what we promised), and purity (nothing else came along for
                      the ride).
                    </p>
                    <p className="text-[17px] leading-relaxed text-neutral-700">
                      Manufacturing follows FDA dietary supplement cGMPs under
                      21 CFR Part 111 — the federal quality framework for
                  ...
                  <section className="space-y-6">
                    ...
                    <p className="text-[17px] leading-relaxed text-neutral-700">
                      Every batch of M3 is tested by an independent third-party
                      lab for:
                    </p>
                    <ul className="space-y-6 pt-2">
                      <li className="flex items-start gap-3">
                        ...
                        <span className="text-[16px] text-neutral-700 leading-relaxed">
                          ...
                          Lead, arsenic, cadmium, and mercury, measured by
                          ICP-MS — the same analytical method used for
                      ...
                      <li className="flex items-start gap-3">
                        ...
                        <span className="text-[16px] text-neutral-700 leading-relaxed">
                          ...
                          Residue screening for common agricultural and
                      ...
                      <li className="flex items-start gap-3">
                        ...
                        <span className="text-[16px] text-neutral-700 leading-relaxed">
                          ...
                          Screening for Salmonella, E. coli, and Staph, plus
                      ...
                      <li className="flex items-start gap-3">
                        ...
                        <span className="text-[16px] text-neutral-700 leading-relaxed">
                          ...
                          Screened against NSF Certified for Sport's 290+
                          prohibited-substance list, so competitive athletes can
                          take M3 without risk of a failed test.
                        </span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="mt-2.5 h-1 w-1 shrink-0 rounded-full bg-neutral-400" />
                        <span className="text-[16px] text-neutral-700 leading-relaxed">
                          ...
                          Accelerated and real-time storage studies confirm the
                          molecules remain intact through the printed expiration
                          date.
                        </span>
                      </li>
                      <li className="flex items-start gap-3">
                        ...
                        <span className="text-[16px] text-neutral-700 leading-relaxed">
                          ...
                          Quantitative assays verify that each capsule contains
                          the stated dose of Urolithin A, Spermidine, and SAC
                  ...
                  <div className="space-y-12 p-6 pb-20">
                    <section>
                      ...
                      <p className="text-base leading-relaxed text-black md:text-lg">
                        In a 16-week randomized, double-blind,
                        placebo-controlled clinical trial in adults aged 40 to
                        65, Urolithin A — the active compound in M3 — improved
                        hamstring muscle strength by 12% over placebo, increased
                        skeletal muscle endurance by 41%, and reduced
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 px-2">
                        <p className="text-[11px] leading-relaxed text-neutral-500 italic">
                          Figure 1. Change in peak torque of the hamstring
                          muscle group (primary strength endpoint) after 16
                          weeks of daily supplementation, versus placebo, in
                          adults aged 40 to 65.
                        </p>
                        <p className="text-[11px] leading-relaxed text-neutral-500 italic">
                          Figure 2. Change in skeletal muscle endurance
                          (contractions performed before volitional fatigue)
                          across 16 weeks of supplementation, relative to
                          baseline.
                        </p>
                      </div>
                    </div>
                    ...
                    <section className="space-y-4">
                      ...
                      <ul className="space-y-4 text-sm leading-relaxed text-neutral-600">
                        <li className="flex items-start gap-3">
                          <span className="font-bold text-black min-w-[12px]">
                            1
                          </span>
                          <span>
                            Singh A, D’Amico D, Andreux PA, et al. Urolithin A
                  ...
                  <div className="space-y-12 p-8 pb-24">
                    ...
                    <div className="space-y-8">
                      <p className="text-[14px] md:text-[18px] text-neutral-600 leading-relaxed font-light">
                        Every cell has two cleanup systems that decide how well
                        it ages.{" "}
                        <span className="text-black italic">Autophagy</span> is
                        general recycling — the cell breaking down and replacing
                        its own damaged proteins.{" "}
                        <span className="text-black font-bold">Mitophagy</span>{" "}
                        is a specialized subset: the removal of damaged
                        mitochondria, the batteries that power every cell. Both
                        processes slow with age. M3 restarts both, through three
                    ...
                    <div className="space-y-16 pt-8">
                      ...
                      <div className="space-y-6">
                        <div className="flex items-center gap-4">
                          ...
                          <span className="bg-neutral-200 px-3 py-1 rounded text-[11px] font-bold text-neutral-500">
                            1,000 mg
                          </span>
                          <span className="bg-[#a638b5]/10 text-[#a638b5] px-3 py-1 rounded text-[11px] font-bold uppercase tracking-wider">
                            PRIMARY
                          </span>
                        </div>
                        <p className="text-[15px] italic text-neutral-500">
                          The mitophagy activator
                        </p>
                        <p className="text-[16px] md:text-[18px] text-neutral-600 leading-relaxed">
                          Restarts the cellular process that removes damaged
                          mitochondria. In adults 40 to 65, daily
                          supplementation over 16 weeks produced direct,
                          measurable increases in mitophagy gene-expression
                          markers in skeletal muscle biopsies, alongside
                          functional improvements in endurance.
                        </p>
                        <div className="pt-2">
                          <ExternalLinkPill
                            href="https://pubmed.ncbi.nlm.nih.gov/35584623/"
                      ...
                      <div className="space-y-6">
                        ...
                        <p className="text-[16px] md:text-[18px] text-neutral-600 leading-relaxed">
                          Reactivates the general protein-recycling pathway that
                          declines with age. Found naturally in wheat germ and
                          aged cheese; supplementation delivers doses well above
                          dietary intake. Restored autophagy is a prerequisite
                          for efficient mitophagy — the cell can't clear broken
                          mitochondria if the general cleanup machinery is
                          slowed.
                        </p>
                        <div className="pt-2">
                          <ExternalLinkPill
                      ...
                      <div className="space-y-6">
                        ...
                        <p className="text-[15px] italic text-neutral-500">
                          The antioxidant upstream of cleanup
                        </p>
                        <p className="text-[16px] md:text-[18px] text-neutral-600 leading-relaxed">
                          Activates{" "}
                          ...
                          , the body's master transcriptional switch for
                          endogenous antioxidant defense. Reduces oxidative
                          damage to mitochondria before they need removal —
                          working upstream of the cleanup systems the other two
                          molecules activate downstream.
                        </p>
                        <div className="pt-2">
                          <ExternalLinkPill
                            href="https://pubmed.ncbi.nlm.nih.gov/25393425/"
              ...
              <div className="fixed right-0 top-0 z-[130] flex h-full w-full flex-col bg-[#F7F8F2] shadow-2xl md:w-[600px] lg:w-[700px] text-black">
                ...
                <div className="sticky top-0 z-10 bg-[#F7F8F2]/90 backdrop-blur-xl">
                  <div className="p-8 md:p-12 pb-6 md:pb-8 flex items-start justify-between">
                    <div className="space-y-2">
                      ...
                      <h2 className="text-3xl font-medium text-black md:text-5xl tracking-tight">
                        {rigorousTestingData.find(
                          (c) => c.id === selectedTestingId,
                        )?.detailTitle || "Rigorous Testing"}
                      </h2>
                ...
                <div className="flex-1 overflow-y-auto px-8 md:px-12 py-8 md:py-12 scrollbar-hide">
                  <div className="space-y-12">
                    ...
                    {rigorousTestingData.find((c) => c.id === selectedTestingId)
                      ?.facilityInfo && (
                      <div className="rounded-[16px] bg-neutral-50 p-8 border border-neutral-100 space-y-2">
                        <p className="text-[15px] md:text-[17px] text-neutral-600">
                          <span className="font-bold text-black min-w-[120px] inline-block">
                            {
                              rigorousTestingData.find(
                                (c) => c.id === selectedTestingId,
                              )?.facilityInfo?.name
              ...
              <div className="fixed right-0 top-0 z-[130] flex h-full w-full flex-col bg-white shadow-2xl md:w-[600px] lg:w-[700px] text-black">
                ...
                <div className="sticky top-0 z-10 bg-white/90 backdrop-blur-xl">
                  <div className="p-8 md:p-12 pb-6 md:pb-8 flex items-start justify-between">
                    <div className="space-y-2">
                      <span className="text-[11px] font-bold tracking-[0.2em] text-[#693979] uppercase">
                        COGNITIVE PERFORMANCE, NEURAL MAINTENANCE, GLYMPHATIC
                        CLEARANCE
                      </span>
                      <h2 className="text-3xl font-medium text-black md:text-5xl tracking-tight">
                        Brain Health
                ...
                <div className="flex-1 overflow-y-auto px-8 md:px-12 py-8 md:py-12 scrollbar-hide">
                  <div className="space-y-12">
                    <section className="space-y-6">
                      <p className="text-[16px] md:text-[18px] text-neutral-600 leading-relaxed">
                        Your brain maintains itself through three overlapping
                        systems. <span className="italic">Autophagy</span>{" "}
                        inside neurons clears protein aggregates.{" "}
                        <span className="italic">
                          Nrf2-mediated antioxidant defense
                        </span>{" "}
                        buffers oxidative damage to neural tissue. And during
                        deep sleep, the{" "}
                        <span className="italic">glymphatic system</span>{" "}
                        flushes metabolic waste from between cells. All three
                        decline with age. M3&apos;s molecules support each
                        pathway — though the evidence base is earlier-stage than
                        for muscle outcomes.
                      </p>
                    </section>
                    ...
                    <section className="space-y-10">
                      <div className="space-y-6">
                        ...
                        <p className="text-[14px] italic text-neutral-500 -mt-4">
                          The neuronal autophagy activator
                        </p>
                        <p className="text-[15px] md:text-[17px] text-neutral-600 leading-relaxed">
                          Crosses the blood-brain barrier. Neurons rely heavily
                          on autophagy to clear protein aggregates that
                          accumulate with age — aggregates implicated in most
                          neurodegenerative conditions. In older adults with
                          subjective cognitive decline, one-year spermidine
                          supplementation produced mixed signals on memory
                          outcomes in the SmartAge trial — positive on some
                          measures, null on others. The cellular mechanism is
                          established; the cognitive endpoint is still being
                          characterized.
                        </p>
                        <ExternalLinkPill
                      ...
                      <div className="space-y-6">
                        ...
                        <p className="text-[14px] italic text-neutral-500 -mt-4">
                          The neural antioxidant
                        </p>
                        <p className="text-[15px] md:text-[17px] text-neutral-600 leading-relaxed">
                          Activates <span className="italic">Nrf2</span> in
                          neural tissue — the master transcriptional switch for
                          endogenous antioxidant defense. Preclinical
                          neuroprotection data is well-established across
                          multiple rodent models; direct human cognitive-outcome
                          trials at supplementation-range doses are limited and
                          developing. Strongest claim at the current dose is
                      ...
                      <div className="space-y-6">
                        ...
                        <p className="text-[14px] italic text-neutral-500 -mt-4">
                          The neural mitochondrial support
                        </p>
                        <p className="text-[15px] md:text-[17px] text-neutral-600 leading-relaxed">
                          Neurons are mitochondrially demanding — the brain
                          consumes roughly 20% of the body&apos;s energy at 2%
                          of body mass, and that energy comes from mitochondria.
                          Mitophagy activation in neural tissue has been
                          demonstrated in preclinical Alzheimer&apos;s and
                          age-related cognitive decline models. Human
                          cognitive-outcome trials specifically targeting brain
                          tissue are emerging, not yet established. Claims here
                          remain mechanistic.
                        </p>
                        <ExternalLinkPill
